    ...
    for x, y, mask, pos in dataloader:
        ...
        with pt.no_grad():
            ...
            if tnow - tchk > 59:
                ...
                wandb.log({"loss0": stat[0], "loss1": stat[1], "acco": stat[2], "acc1": stat[3], "current_lr": optimizer.param_groups[0]['lr']})
                stat, tchk = [], tnow
