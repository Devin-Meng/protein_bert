...
class PosEmbed(nn.Module):
    def __init__(self, cio, maxembed=32*12):
        ...
        self.embed0 = nn.Embedding(maxembed+1, cio//2, padding_idx=0)
        self.embed1 = nn.Embedding(maxembed+1, cio//2, padding_idx=0)
...
class Transformer(nn.Module):
    def __init__(self, width, dimhead, numhead, depth):
        ...
        self.embed = nn.Embedding(28+1, width, padding_idx=0)
